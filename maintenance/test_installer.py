...
class InstallerCliTests(unittest.TestCase):
    ...
    def test_clean_outdated_managed_copy_upgrades_without_accept_drift(self) -> None:
        with tempfile.TemporaryDirectory() as temp:
            ...
            skill.write_text(skill.read_text(encoding="utf-8").replace('version: "2.3.4"', 'version: "2.2.1"'), encoding="utf-8")
            ...
            self.assertIn('version: "2.3.4"', skill.read_text(encoding="utf-8"))
